...
LTSpice has most of the components needed, but I had to import a library for the LM3478. I found this library in a [project log](https://hackaday.io/project/27899-nixie-tube-power-supply/log/69767-ltspice) by [Paul Andrews](https://github.com/judge2005) on Hackaday. That library was causeing some errors in LTSpice so I did some research an realized I needed to add two more "0" place holders after each "pause" statement. The updated library that I used LM3478 can be downloaded [here](). The second library I needed was for the [csd17553q5a](https://github.com/JoshuaMularczyk/Solar-Smartphone-Charger/blob/main/Simulations/CSD17553Q5A.lib) mosfet. The schottkey diode used in the simulation is also not the exact same component as used in the schematic but another schottkey diode with the same specifications was used in its place. The simulation ran over night to get to 7 ms. The prolonged period of time was likely due to the laptop it was running on as well as the coupled inductors in the circuit.
